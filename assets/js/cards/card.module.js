...
function dragNDropCard() {
    ...
    // });
    // ! avec la méthode getElementsByClassName, on obtient une collection, et on doit utiliser foreach en appaelant directement le prototype de Array.forEach sur cette collection.
    // ! on pourrait aussi convertir la collection en tableau : const elements = Array.from(cardsContainerPourCraner)
