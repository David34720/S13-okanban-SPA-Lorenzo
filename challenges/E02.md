...
// - on selectionne le template `dialog-form-template`
// - on clone le template `dialog-form-template`
// - on selectionne le template `form-list-template`
// - on clone le template `form-list-template`
// - on intègre le clone `form-list-template` dans le clone `dialog-form-template`
// - on selectionne la fenêtre de dialogue
// - on intègre le tout dans la fenêtre de dialogue et on l'affiche
//   - utiliser la méthode  → `.showModal()`
```
